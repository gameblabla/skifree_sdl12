...
const uint32_t actorFrameToSpriteTbl[] = {
    0x1, 0x2, 0x3, 0x4,
    0x5, 0x6, 0x7, 0x8,
    0x9, 0xA, 0xB, 0xC,
    0xD, 0xE, 0xF, 0x10,
...
int32_t statusWindowHeight;
int32_t statusWindowTotalTextWidth;
int32_t statusWindowLabelWidth;
...
int playerX;
int32_t playerY;
uint32_t permObjectCount;
int32_t scratchBitmapWidth;
int32_t scratchBitmapHeight;
int elapsedTime;
...
int INT_0040c968;
int INT_0040c960;
int32_t DAT_0040c5d8;
int32_t DAT_0040c714;
int DAT_0040c760;
int32_t prevMouseX;
int32_t prevMouseY;
